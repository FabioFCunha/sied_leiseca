export const defaultGoalRows = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "shopping", label: "3.6 - SHOPPING/CENTRO COMERCIAL", average: 15, target: 20 },
      { key: "parks", label: "3.7 - PRAÇAS/PARQUES PÚBLICOS", average: 0, target: 0 },
      { key: "tourist_spots", label: "3.8 - PONTOS TURÍSTICOS", average: 0, target: 0 },
      { key: "social_actions", label: "3.9 - AÇÃO SOCIAL", average: 56, target: 50 },
      { key: "joint_inspections", label: "3.10 - AÇÃO CONJUNTA COM A FISCALIZAÇÃO", average: 0, target: 0 },
      { key: "other_actions", label: "3.11 - OUTROS", average: 675, target: 630 },
    ],
  },
  {
