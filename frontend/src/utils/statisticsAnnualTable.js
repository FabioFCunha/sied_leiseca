...
export const ANNUAL_TABLE_GROUPS = [
  ...
  { title: "AÇÕES", rows: [["STREET_ACTIONS - Geral", "Total de ações"], ["ACTION - Bares", "Bares/Restaurantes"], ["ACTION - Pedágio", "Pedágio"], ["ACTION - Praças Esportivas", "Praças Esportivas"], ["ACTION - Praia", "Praia"], ["ACTION - Eventos", "Eventos"], ["ACTION - Shopping", "Shopping/Centros Comerciais"], ["ACTION - Praças/Parques Públicos", "Praças/Parques Públicos"], ["ACTION - Pontos turísticos", "Pontos Turísticos"], ["ACTION - Ação Social", "Ação Social"], ["ACTION - Outros", "Outros"], ["ACTION - Ação conjunta com a fiscalização", "Ação conjunta com a Fiscalização"]] },
